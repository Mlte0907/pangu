...
TOOLS = [
    ...
    {
        "name": "pangu_import_smart",
        "description": "\u667a\u80fd\u5bfc\u5165\uff08\u81ea\u52a8\u68c0\u6d4b\u683c\u5f0f\uff09",
    },
    ...
    {
        "name": "pangu_feishu_send",
        "description": "\u53d1\u9001\u98de\u4e66\u901a\u77e5\uff08\u6587\u672c\u6d88\u606f\uff09",
    },
    {"name": "pangu_feishu_card", "description": "\u53d1\u9001\u98de\u4e66\u5361\u7247\u901a\u77e5"},
    {"name": "pangu_feishu_status", "description": "\u67e5\u770b\u98de\u4e66 Webhook \u72b6\u6001"},
    {
        "name": "pangu_watch_directory",
        "description": "\u76d1\u63a7\u76ee\u5f55\u53d8\u66f4\u5e76\u81ea\u52a8\u63d0\u53d6\u8bb0\u5fc6",
    },
    ...
    try:
        ...
        if count > 0:
            get_event_stream(server.config).emit(
                "memory.collect", "", {"count": count, "sources": result.get("sources", {})}
            )
    except Exception:
        pass
    return json.dumps(result, ensure_ascii=False, indent=2)
    ...
    return json.dumps(
        {
            ...
            "webhook_url": cfg.feishu_webhook_url[:50] + "..."
            if len(cfg.feishu_webhook_url) > 50
            else cfg.feishu_webhook_url,
        },
        ensure_ascii=False,
        indent=2,
    )
