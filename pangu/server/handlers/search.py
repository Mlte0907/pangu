...
from ...memory.fts_search import FTS5SearchEngine, get_search_stats
from ...memory.hybrid_search import hybrid_search

TOOLS = [
    {
        "name": "pangu_cluster_memories",
        "description": "\u5c06\u8bb0\u5fc6\u81ea\u52a8\u805a\u7c7b\u4e3a\u4e3b\u9898\u5206\u7ec4",
    },
    {
        "name": "pangu_find_related",
        "description": "\u627e\u5230\u4e0e\u6307\u5b9a\u8bb0\u5fc6\u6700\u76f8\u5173\u7684\u5176\u4ed6\u8bb0\u5fc6",
    },
    {
        "name": "pangu_fts_search",
        "description": "FTS5\u5168\u6587+\u5411\u91cf\u6df7\u5408\u641c\u7d22(RRF\u878d\u5408)",
    },
    {"name": "pangu_fts_search_stats", "description": "\u83b7\u53d6\u641c\u7d22\u5f15\u64ce\u7edf\u8ba1"},
    {
        "name": "pangu_natural_query",
        "description": "\u81ea\u7136\u8bed\u8a00\u67e5\u8be2\u8bb0\u5fc6\uff08\u652f\u6301\u65f6\u95f4\u3001\u7a7a\u95f4\u3001\u91cd\u8981\u6027\u7b49\u8bed\u4e49\u7406\u89e3\uff09",
    },
    {
        "name": "pangu_recommend",
        "description": "\u57fa\u4e8e\u4e0a\u4e0b\u6587\u667a\u80fd\u63a8\u8350\u76f8\u5173\u8bb0\u5fc6",
    },
    {
        "name": "pangu_conversational_search",
        "description": "\u5bf9\u8bdd\u5f0f\u8bb0\u5fc6\u641c\u7d22\uff08\u652f\u6301\u591a\u8f6e\u6f84\u6e05\uff09",
    },
    {
        "name": "pangu_memory_insights",
        "description": "\u4ece\u8bb0\u5fc6\u4e2d\u63d0\u53d6\u6d1e\u5bdf\u548c\u6a21\u5f0f",
    },
    {
        "name": "pangu_hybrid_search",
        "description": "FTS+\u5411\u91cf+KG\u4e09\u8def\u53ec\u56de RRF\u878d\u5408\u68c0\u7d22",
    },
    {"name": "pangu_cluster_by_tags", "description": "\u6309\u6807\u7b7e\u805a\u7c7b\u641c\u7d22\u7ed3\u679c"},
    {"name": "pangu_cluster_by_time", "description": "\u6309\u65f6\u95f4\u805a\u7c7b\u641c\u7d22\u7ed3\u679c"},
    {
        "name": "pangu_hierarchical_cluster",
        "description": "\u5c42\u6b21\u805a\u7c7b\uff08\u57fa\u4e8e\u5411\u91cf\u76f8\u4f3c\u5ea6\uff09",
    },
    ...
    {
        "name": "pangu_rerank",
        "description": "\u8bed\u4e49\u91cd\u6392\u5e8f\u641c\u7d22\u7ed3\u679c\uff08\u4e0a\u4e0b\u6587+\u65f6\u6548+\u91cd\u8981\u6027+\u8d28\u91cf\uff09",
    },
    {
        "name": "pangu_search_explain",
        "description": "\u641c\u7d22\u7ed3\u679c\u89e3\u91ca\uff08\u6bcf\u6761\u7ed3\u679c\u9644\u5e26\u4e3a\u4ec0\u4e48\u5339\u914d\uff09",
    },
    {
        "name": "pangu_proactive_remind",
        "description": "\u4e3b\u52a8\u63d0\u9192\uff1a\u68c0\u6d4b\u91cd\u590d\u95ee\u9898\uff0c\u63a8\u9001\u76f8\u5173\u8bb0\u5fc6",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "pangu_user_patterns",
        "description": "\u83b7\u53d6\u7528\u6237\u5173\u6ce8\u6a21\u5f0f\uff08\u70ed\u95e8\u4e3b\u9898\u3001\u63d0\u95ee\u9891\u7387\uff09",
    },
    {
        "name": "pangu_repeated_questions",
        "description": "\u83b7\u53d6\u91cd\u590d\u63d0\u95ee\u7684\u95ee\u9898",
        "parameters": {
            "type": "object",
            "properties": {
                "min_count": {"type": "integer", "description": "\u6700\u5c0f\u91cd\u590d\u6b21\u6570", "default": 2},
            },
        },
    },
    {
        "name": "pangu_self_evaluate",
        "description": "\u8fd0\u884c\u81ea\u8bc4\u4f30\uff0c\u68c0\u67e5\u7cfb\u7edf\u5065\u5eb7\u72b6\u51b5",
    },
    {
        "name": "pangu_self_repair",
        "description": "\u8fd0\u884c\u81ea\u52a8\u4fee\u590d\uff08\u53bb\u91cd\u3001\u8865\u6807\u7b7e\u3001\u6e05\u7406\u566a\u58f0\uff09",
    },
    {
    ...
    {
        "name": "pangu_fuxi_insights",
        "description": "\u83b7\u53d6 Fuxi \u6df1\u5ea6\u6d1e\u5bdf\uff08\u77e5\u8bc6\u7a7a\u767d\u3001\u6a21\u5f0f\u5206\u6790\u3001\u6539\u8fdb\u5efa\u8bae\uff09",
    },
    {
        "name": "pangu_knowledge_gaps",
        "description": "\u53d1\u73b0\u77e5\u8bc6\u7a7a\u767d",
    },
    {
        "name": "pangu_user_behavior",
        ...
        results.append(
            {
                ...
                "suggestions": ["缩小时间范围", "指定空间(Wing)", "提高重要性阈值"],
            }
        )
...
async def handle_memory_insights(server, drawers, arguments):
    ...
    from ...memory.natural_query import _analyze_memories
    ...
    # 模式发现：接入现存 PatternEngine（替代不存在的 MCPServer._discover_simple_patterns）
    pattern_engine = PatternEngine(server.config)
    discovered = pattern_engine.discover_all(filtered)
    insights = {
        ...
        "patterns": {
            ...
            "stats": pattern_engine.pattern_stats(discovered),
        },
    }
...
async def handle_dedup_results(server, drawers, arguments):
    ...
    return json.dumps(
        {"results": deduped, "total": len(deduped), "removed": len(results) - len(deduped)},
        ensure_ascii=False,
        indent=2,
    )
...
async def handle_recommend_similar(server, drawers, arguments):
    ...
    return json.dumps(
        {
            "recommendations": [
                {"id": r.memory_id, "preview": r.content_preview, "score": r.score, "reason": r.reason} for r in results
            ],
            "count": len(results),
        },
        ensure_ascii=False,
...
async def handle_recommend_timely(server, drawers, arguments):
    ...
    return json.dumps(
        {
            "recommendations": [
                {"id": r.memory_id, "preview": r.content_preview, "wing": r.wing, "score": r.score, "reason": r.reason}
                for r in results
            ],
            "count": len(results),
        },
...
async def handle_proactive_remind(server, drawers, arguments):
    ...
    reminders = engine.on_new_question(question)
    result = {
        "question": question,
...
HANDLERS["pangu_proactive_remind"] = handle_proactive_remind


async def handle_user_patterns(server, drawers, arguments):
    """获取用户关注模式"""
    from ...memory.proactive_reminder import get_proactive_engine

    engine = get_proactive_engine()
    patterns = engine.get_user_interest_patterns()
    return json.dumps(patterns, ensure_ascii=False, indent=2)


HANDLERS["pangu_user_patterns"] = handle_user_patterns


async def handle_repeated_questions(server, drawers, arguments):
    """获取重复提问的问题"""
    from ...memory.proactive_reminder import get_proactive_engine

    engine = get_proactive_engine()
    min_count = arguments.get("min_count", 2)
    repeated = engine.get_repeated_questions(min_count)
    return json.dumps({"repeated": repeated, "total": len(repeated)}, ensure_ascii=False, indent=2)


HANDLERS["pangu_repeated_questions"] = handle_repeated_questions
...
async def handle_self_repair(server, drawers, arguments):
    """运行自动修复"""
    from ...memory.self_repair import get_self_repair_engine
...
async def handle_fuxi_insights(server, drawers, arguments):
    ...
    report = bridge.get_comprehensive_report()
    return json.dumps(report, ensure_ascii=False, indent=2)


HANDLERS["pangu_fuxi_insights"] = handle_fuxi_insights


async def handle_knowledge_gaps(server, drawers, arguments):
    """发现知识空白"""
    from ...memory.fuxi_bridge import get_fuxi_bridge
...
async def handle_user_behavior(server, drawers, arguments):
    """分析用户行为模式"""
    from ...memory.fuxi_bridge import get_fuxi_bridge
