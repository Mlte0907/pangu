...
TOOLS = [
    {
        "name": "pangu_detect_conflicts",
        "description": "\u68c0\u6d4b\u8bb0\u5fc6\u4e2d\u7684\u77db\u76fe\u548c\u4e0d\u4e00\u81f4",
    },
    {
        "name": "pangu_check_pair",
        "description": "\u68c0\u67e5\u4e24\u6761\u8bb0\u5fc6\u662f\u5426\u5b58\u5728\u51b2\u7a81",
    },
    {
        "name": "pangu_find_duplicates",
        "description": "\u68c0\u6d4b\u91cd\u590d\u6216\u9ad8\u5ea6\u76f8\u4f3c\u7684\u8bb0\u5fc6",
    },
    ...
    {
        "name": "pangu_enhanced_contradictions",
        "description": "LLM\u9a71\u52a8\u77db\u76fe\u68c0\u6d4b\uff086\u79cd\u88c1\u51b3\uff09",
    },
    {"name": "pangu_trajectory_track", "description": "\u8ffd\u8e2a\u8bb0\u5fc6\u65f6\u95f4\u8f68\u8ff9"},
    {
        "name": "pangu_trajectory_compare",
        "description": "\u6bd4\u8f83\u4e24\u4e2a\u65f6\u95f4\u6bb5\u7684\u8bb0\u5fc6\u53d8\u5316",
    },
    {"name": "pangu_compress_by_tags", "description": "\u6309\u6807\u7b7e\u805a\u7c7b\u538b\u7f29\u8bb0\u5fc6"},
    {"name": "pangu_find_duplicates", "description": "\u53d1\u73b0\u8bed\u4e49\u91cd\u590d\u8bb0\u5fc6"},
    {
        "name": "pangu_reassess_importance",
        "description": "\u57fa\u4e8e\u8bb0\u5fc6\u7f51\u7edc\u91cd\u65b0\u8bc4\u4f30\u91cd\u8981\u6027",
    },
    ...
    {
        "name": "pangu_quality_analyze",
        "description": "\u5206\u6790\u8bb0\u5fc6\u8d28\u91cf\uff08\u8bc4\u5206/\u53bb\u91cd/\u6807\u7b7e\uff09",
    },
    {
        "name": "pangu_quality_fix",
        "description": "\u81ea\u52a8\u4fee\u590d\u8bb0\u5fc6\u8d28\u91cf\u95ee\u9898\uff08\u6807\u7b7e/\u53bb\u91cd\uff09",
    },
]
...
async def handle_quality_fix(server, drawers, arguments):
    ...
    try:
        ...
        get_event_stream(server.config).emit(
            "memory.quality_fix",
            "",
            {
