...
TOOLS = [
    ...
    {
        "name": "pangu_onnx_embed",
        "description": "\u4f7f\u7528 ONNX \u672c\u5730\u63a8\u7406\u5d4c\u5165\u5355\u6761\u6587\u672c\uff08CPU \u52a0\u901f 3-10x\uff09",
    },
    {"name": "pangu_onnx_embed_batch", "description": "ONNX \u6279\u91cf\u5d4c\u5165\u591a\u6761\u6587\u672c"},
    {
        "name": "pangu_onnx_status",
        "description": "\u83b7\u53d6 ONNX \u5d4c\u5165\u5668\u72b6\u6001\uff08\u6a21\u578b/\u7f13\u5b58/\u6027\u80fd\uff09",
    },
    {
        "name": "pangu_onnx_similarity",
        "description": "\u4f7f\u7528 ONNX \u8ba1\u7b97\u4e24\u6761\u6587\u672c\u7684\u4f59\u5f26\u76f8\u4f3c\u5ea6",
    },
]
...
async def handle_vector_index_build(server, drawers, arguments):
    ...
    idx = get_vector_index()
    success = idx.build_from_drawers(drawers, embedder=embedder, min_count=arguments.get("min_count", 1))
    return json.dumps(
        {
