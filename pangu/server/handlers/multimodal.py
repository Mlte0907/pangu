...
TOOLS = [
    {
        "name": "pangu_ingest_file",
        "description": "\u4ece\u6587\u4ef6\u63d0\u53d6\u591a\u6a21\u6001\u8bb0\u5fc6\uff08\u56fe\u7247/PDF/\u6587\u672c/\u97f3\u9891\uff09",
    },
    {
        "name": "pangu_ingest_url",
        "description": "\u4eceURL\u6293\u53d6\u7f51\u9875\u5185\u5bb9\u5b58\u5165\u8bb0\u5fc6",
    },
    {
        "name": "pangu_ingest_text",
        "description": "\u76f4\u63a5\u5b58\u5165\u6587\u672c\u8bb0\u5fc6\uff08\u652f\u6301\u81ea\u5b9a\u4e49\u6a21\u6001\u6807\u7b7e\uff09",
    },
    {
        "name": "pangu_image_embed",
        "description": "\u56fe\u7247CLIP\u5d4c\u5165+\u5206\u6790\uff08\u5c3a\u5bf8/\u989c\u8272/\u5206\u7c7b\uff09",
    },
    {"name": "pangu_image_classify", "description": "\u56fe\u7247\u96f6\u6837\u672c\u5206\u7c7b\uff08CLIP\uff09"},
    {
        "name": "pangu_image_search_by_text",
        "description": "\u4ee5\u6587\u641c\u56fe\uff08\u6587\u672c\u5339\u914d\u56fe\u7247\u8bb0\u5fc6\uff09",
    },
    {
        "name": "pangu_image_search_by_image",
        "description": "\u4ee5\u56fe\u641c\u56fe\uff08\u56fe\u7247\u5339\u914d\u56fe\u7247\u8bb0\u5fc6\uff09",
    },
    {
        "name": "pangu_video_ingest",
        "description": "\u4ece\u89c6\u9891\u63d0\u53d6\u8bb0\u5fc6\uff08\u5143\u6570\u636e+\u5173\u952e\u5e27+CLIP\u5206\u6790\uff09",
    },
    {
        "name": "pangu_video_metadata",
        "description": "\u63d0\u53d6\u89c6\u9891\u5143\u6570\u636e\uff08\u65f6\u957f/\u5206\u8fa8\u7387/\u7f16\u7801/\u5e27\u7387\uff09",
    },
    {"name": "pangu_video_frames", "description": "\u63d0\u53d6\u89c6\u9891\u5173\u952e\u5e27"},
    {"name": "pangu_audio_transcribe", "description": "\u97f3\u9891\u8bed\u97f3\u8f6c\u6587\u5b57\uff08Whisper\uff09"},
    {
        "name": "pangu_audio_metadata",
        "description": "\u63d0\u53d6\u97f3\u9891\u5143\u6570\u636e\uff08\u65f6\u957f/\u683c\u5f0f/\u91c7\u6837\u7387\uff09",
    },
    {
        "name": "pangu_audio_ingest",
        "description": "\u4ece\u97f3\u9891\u63d0\u53d6\u8bb0\u5fc6\uff08\u8f6c\u5199+\u5143\u6570\u636e+\u81ea\u52a8\u5165\u5e93\uff09",
    },
    {
        "name": "pangu_multimodal_search",
        "description": "\u8de8\u6a21\u6001\u7edf\u4e00\u641c\u7d22\uff08\u6587\u672c\u641c\u6240\u6709\u6a21\u6001\uff1a\u6587\u672c/\u56fe\u7247/\u89c6\u9891/\u97f3\u9891\uff09",
    },
    {
        "name": "pangu_multimodal_summary",
        "description": "\u8de8\u6a21\u6001\u7efc\u5408\u6458\u8981\uff08\u7efc\u5408\u6240\u6709\u6a21\u6001\u5185\u5bb9\u751f\u6210\u6458\u8981\uff09",
    },
    {"name": "pangu_summary_by_topic", "description": "\u6309\u4e3b\u9898\u805a\u5408\u591a\u6a21\u6001\u6458\u8981"},
    {
        "name": "pangu_summary_timeline",
        "description": "\u6309\u65f6\u95f4\u7ebf\u751f\u6210\u591a\u6a21\u6001\u6458\u8981",
    },
]
...
async def handle_summary_by_topic(server, drawers, arguments):
    ...
    engine = get_multimodal_summary(server.config)
    result = engine.summarize_by_topic(drawers, topic, limit=arguments.get("limit", 20))
    return json.dumps(result, ensure_ascii=False, indent=2)
