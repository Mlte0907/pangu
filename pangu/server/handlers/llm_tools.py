...
TOOLS = [
    ...
    {
        "name": "pangu_deep_emotion_trajectory",
        "description": "\u60c5\u7eea\u8f68\u8ff9\u8ffd\u8e2a\uff08\u901f\u5ea6/\u52a0\u901f\u5ea6/\u8d8b\u52bf\uff09",
    },
    {
        "name": "pangu_deep_emotion_decompose",
        "description": "\u6df7\u5408\u60c5\u7eea\u89e3\u8026\uff08\u8bc6\u522b\u590d\u6742\u60c5\u7eea\u4e2d\u7684\u591a\u4e2a\u6210\u5206\uff09",
    },
    {"name": "pangu_deep_emotion_stats", "description": "\u83b7\u53d6\u6df1\u5ea6\u60c5\u7eea\u7edf\u8ba1"},
    {
        "name": "pangu_debate_run",
        "description": "\u8fd0\u884c\u591a\u7b56\u7565\u8fa9\u8bba\uff08\u5206\u6790/\u521b\u610f/\u4fdd\u5b88\u4e09\u7b56\u7565\u8bc4\u5206\u9009\u4f18\uff09",
    },
    {"name": "pangu_debate_stats", "description": "\u83b7\u53d6\u8fa9\u8bba\u7edf\u8ba1"},
    {
        "name": "pangu_narrative_generate",
        "description": "\u751f\u6210\u8bb0\u5fc6\u53d9\u4e8b\uff08\u6309Wing\u805a\u5408\u4e3a\u8fde\u8d2f\u53d9\u4e8b\u7ebf\uff09",
    },
    {"name": "pangu_narrative_themes", "description": "\u63d0\u53d6\u8bb0\u5fc6\u4e3b\u9898"},
    {"name": "pangu_narrative_identity", "description": "\u751f\u6210\u8eab\u4efd\u8fde\u7eed\u6027\u53d9\u4e8b"},
    {
        "name": "pangu_llm_cache_stats",
        "description": "\u83b7\u53d6 LLM \u7f13\u5b58\u7edf\u8ba1\uff08\u547d\u4e2d\u3001token\u3001\u6210\u672c\u3001\u78c1\u76d8\uff09",
    },
    {
        "name": "pangu_llm_cache_top",
        "description": "\u83b7\u53d6\u8bbf\u95ee\u6700\u9891\u7e41\u7684\u7f13\u5b58\u952e",
    },
    {
        "name": "pangu_llm_cache_clear",
        "description": "\u6e05\u7a7a LLM \u7f13\u5b58\uff08\u5185\u5b58/\u78c1\u76d8\uff09",
    },
    {
        "name": "pangu_llm_cache_metrics",
        "description": "\u5bfc\u51fa Prometheus \u683c\u5f0f LLM \u7f13\u5b58\u6307\u6807",
    },
    {
        "name": "pangu_llm_cache_warmup",
        "description": "\u9884\u70ed LLM \u7f13\u5b58\uff08\u6309 prompt \u5217\u8868\u6279\u91cf\u586b\u5145\uff09",
    },
    {
        "name": "pangu_llm_cache_warmup_log",
        "description": "\u67e5\u770b LLM \u7f13\u5b58\u9884\u70ed\u5ba1\u8ba1\u65e5\u5fd7",
    },
    {
        "name": "pangu_llm_cache_vacuum",
        "description": "\u5bf9\u6301\u4e45\u5316\u7f13\u5b58\u6267\u884c VACUUM\uff0c\u91ca\u653e SQLite \u788e\u7247\u7a7a\u95f4",
    },
    {
        "name": "pangu_llm_cache_config",
        "description": "\u67e5\u770b\u5f53\u524d LLM \u7f13\u5b58\u76f8\u5173\u914d\u7f6e",
    },
]
...
async def handle_insight(server, drawers, arguments):
    """从记忆中提取洞察"""
    related = (
        server.search.search(arguments.get("topic", ""), drawers)
        if arguments.get("topic")
        else [{"content": d.content, "wing": d.wing, "room": d.room} for d in drawers[:5]]
    )
...
async def handle_llm_cache_warmup(server, drawers, arguments):
    ...
    result = await server.llm.warmup_cache(prompts, concurrency=concurrency, skip_existing=skip_existing)
    return json.dumps(result, ensure_ascii=False)
...
async def handle_llm_cache_vacuum(server, drawers, arguments):
    ...
    return json.dumps(server.llm.vacuum_persistent_cache(), ensure_ascii=False)
...
async def handle_llm_cache_config(server, drawers, arguments):
    ...
    cfg_keys = [
        ...
        "llm_cache_max",
        "llm_cache_persist",
        "llm_cache_persist_path",
        "llm_cache_ttl_days",
        "llm_cache_max_disk_mb",
        "llm_cache_write_throttle",
        "llm_cache_warmup_on_start",
        "llm_cache_warmup_prompts",
        "llm_cache_vacuum_on_start",
