...
class Drawer:
    ...
    def __post_init__(self):
        self.importance = self._coerce_float(self.importance, 3.0)
        self.emotional_weight = self._coerce_float(self.emotional_weight, 0.0)
    ...
    def _coerce_float(value, default: float = 0.0) -> float:
        """将任意值安全转为 float；字符串如 'high'/'low' 映射为数值。"""
